        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href=#><img class="w-full h-screen bg-gray-800"
                        src="https://source.unsplash.com/user/erondu/3000x900" alt="image" /></a>
            </div>
            <div class="swiper-slide">
                <a href=#><img class="w-full h-screen bg-gray-800"
                        src="https://source.unsplash.com/collection/190727/3000x900" alt="image" /></a>
            </div>
            <div class="swiper-slide">
                <a href=#><img class="w-full h-screen bg-gray-800"
                        src="https://source.unsplash.com/collection/190728/3000x900" alt="image" /></a>
            </div>
        </div>
        ...
        <div class="container mx-auto px-8">
            <div class="w-full flex flex-col md:flex-row py-6">
                <div class="flex-1 mb-6 text-black">
                    <img src="http://w3.poltekip.ac.id/image/logo.0dd8ff8.png" class="h-20 w-auto">
                    <p class="mt-2 text-lg text-gray-500 font-bold">
                        POLITEKNIK
                    </p>
                    <p class="text-md text-gray-500 font-bold">ILMU PERMASYARAKATAN</p>
                    <p class="text-sm text-gray-500 font-bold">KEMENTRIAN HUKUM DAN RI</p>
                </div>
                <div class="flex-1">
